  ...
  <Html>
    ...
    <Body style={{ fontFamily: "Arial, sans-serif" }}>
      <Container>
        ...
        <Text>
          You have been invited to join {organizationName} on PocketFinance by{" "}
          {inviterName}.
        </Text>
        ...
        <Text>
          Please use this OTP to complete your registration on PocketFinance.
        </Text>
        <Button
          href={`${env.NEXT_PUBLIC_APP_URL}/register`}
          style={{
            background: "#007bff",
            color: "#ffffff",
            padding: "10px 20px",
