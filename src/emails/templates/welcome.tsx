...
export default function WelcomeEmail({ name = "Viktor" }: { name: string }) {
  return (
    <Html>
      <Head>
        <Font
        ...
        <Body className="bg-white font-mono">
          <Container className="mx-auto py-5 pb-12 max-w-[580px]">
            ...
            <Text className="text-sm leading-7 pb-2 font-mono">
              We&apos;re excited to help you automate your localization
              workflow. Here&apos;s what you can do with Languine:
            </Text>
